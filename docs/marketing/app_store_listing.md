...
Track your portfolio alongside live macro data, FRED economics, and AI insights.
...
Ask questions about your portfolio and get answers through the lens of Ray Dalio, Benjamin Graham, or Jack Bogle. The AI uses your actual holdings and macro data.

**BUDGET MANAGER**
Track monthly income, expenses by category, and savings rate trends.

**PRIVACY-FIRST**
Bank-grade encryption. We never sell your data. Plaid for secure account linking (same provider used by Venmo and Robinhood).

Free tier with full market data. Pro at $12/month for advanced features.
...
• Portfolio tracking: stocks, ETFs, crypto, physical metals
• FRED economic data: yield curves, CPI, GDP, unemployment
• Sentiment gauges: Fear & Greed, CAPE ratio, Buffett Indicator
• AI investment advisor with Dalio, Graham, Bogle frameworks
• Budget manager: income, expenses, savings rate
• CSV import from Fidelity, Schwab, Vanguard
• Plaid account linking
• Custom pulse cards with ratio tracking

Free tier available. Pro at $12/month.

---

## Keywords (iOS, 100 chars)
portfolio,tracker,macro,investing,gold,silver,stocks,FRED,yield,curve,budget,net,worth,sentiment
...
- AI investment advisor with portfolio context
- FRED economic data integration
- Sentiment gauges and FedWatch tracker
- Budget and savings rate manager
- Dark mode and light mode themes

## Privacy Policy URL
https://nickelanddime.io/privacy

## Terms of Service URL
https://nickelanddime.io/terms

## Support URL
mailto:support@nickelanddime.io
