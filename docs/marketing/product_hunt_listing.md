...
Hi Product Hunt! I'm Curtis, the solo developer behind Nickel & Dime.

I built this because I was tired of my daily workflow: check my brokerage app, then open FRED for yield curve data, then Twitter for gold prices, then a spreadsheet for my net worth, then another tab for the economic calendar. Every morning, five different tools for one question: "How is my portfolio positioned in this macro environment?"
...
- [ ] Schedule for Tuesday or Wednesday, 12:01 AM PST
- [ ] Create a "PRODUCTHUNT" promo code in Stripe for 3 months free
- [ ] Line up 10-15 supporters to upvote and comment in the first 2 hours
- [ ] Post on Twitter at 6 AM EST with link
- [ ] Post in Skool community
- [ ] Respond to every comment within 1 hour
- [ ] Share in Discord if applicable
- [ ] Email existing users with the PH link

## Maker Bio
Solo developer building tools for self-directed investors. Macro-focused, privacy-first.
